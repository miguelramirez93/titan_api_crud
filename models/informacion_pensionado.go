...
func GetPensionado( idProveedorString int) (v [] InformacionPensionado) {
	...
	_, err := o.Raw("SELECT informacion_proveedor, valor_pension_asignada FROM personal.informacion_persona_pensionado WHERE informacion_proveedor ="+id_proveedor).QueryRows(&temp)
	if err == nil {
